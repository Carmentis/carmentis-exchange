  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Box className="mb-4 p-3 glass-dark rounded-lg">
        <Typography variant="body2" className="text-black/70">
          Selected payment method: <strong>{formData.paymentMethod === 'card' ? 'Card Payment' : formData.paymentMethod === 'sepa' ? 'SEPA Transfer' : 'Cryptocurrency'}</strong>
        </Typography>
      </Box>
    ...
    try {
      ...
      if (formData.paymentMethod === 'card') {
        await processCardPayment({
          ...
          description: `Purchase of ${formData.tokenAmount} tokens`,
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <Typography variant="subtitle2" className="font-semibold text-black/80">
                  €{formData.tokenAmount.toFixed(2)}
                </Typography>
              </div>
            </div>
          </Box>
